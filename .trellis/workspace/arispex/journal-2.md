...
## Session 75: 我的背包 / 用户背包 / 进度 页面按 DESIGN.md 重构

**Date**: 2026-05-04
**Task**: 我的背包 / 用户背包 / 进度 页面按 DESIGN.md 重构
**Branch**: `main`
...
把 查看商店 的商品列表从单列 list 改成 2 列 grid（镜像 9f42d9f 的 lottery_view 改动），卡片内部布局保持不变；默认每页条数 10 → 20，上限 50 → 100。
