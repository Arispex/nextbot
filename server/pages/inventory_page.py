...
def build_payload(
    *,
    ...
    return {
        ...
        "online_time_text": str(online_time_text),
        "map_exploration_text": str(map_exploration_text),
...
def render(payload: dict[str, Any]) -> bytes:
    ...
    data = {
        ...
        "online_time_text": payload.get("online_time_text", ""),
        "map_exploration_text": payload.get("map_exploration_text", ""),
